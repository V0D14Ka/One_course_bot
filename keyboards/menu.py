...
class InlineMenu:
    ...
    """
    menu_cd = CallbackData("show_menu", "level", "category", "item_id", "to_change", "flag", "offset")

    def make_callback_data(self, level, category=0, item_id=0, to_change=0, flag=0, offset=0):
        """
            Создание callback меню админа
        """
        return self.menu_cd.new(level=level, category=category, item_id=item_id, to_change=to_change,
