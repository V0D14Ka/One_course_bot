...
flowchart TB;
    ...
    Выбор одного из разделов --> КТ;
    КТ --> Список кейсов;
    КТ --> Методика;
    КТ --> Отправить на проверку;
    
    
    /checkpoints --> Список КТ;
    Список КТ --> Выбор КТ;
    Выбор КТ --> КТ;
    ...
    /schedule --> Расписание семинаров;
    /schedule --> Расписание КТ;
    /schedule --> На ближайшую неделю;
    /schedule --> На ближайший месяц;
    
    Расписание лекций --> Интеграция с Google Calendar;
    Расписание семинаров --> Интеграция с Google Calendar;
    Расписание КТ --> Интеграция с Google Calendar;
    На ближайшую неделю --> Интеграция с Google Calendar;
    На ближайший месяц --> Интеграция с Google Calendar;
    
    /FAQ --> Написать преподавателю;
    /FAQ --> Часто задаваемые вопросы;
    
    /knowledge --> Методики;
    /knowledge --> Заначка;
    
    /personal --> Информация о себе;
    /personal --> Редактировать;
    
    /team --> Вступить в команду;
    /team --> Создать команду;
    /team --> Покинуть команду;
